...
🎓 Estudante de Engenharia de Software na SATC  
💻 Interessada em desenvolvimento de software, desenvolvimento de jogos, desenvolvimento web e UX/UI  
📚 Atualmente estudando programação, testes de software e desenvolvimento web  
🎨 Experiência com prototipação de interfaces no Figma e criação de projetos acadêmicos  
...
![Construct 2](https://img.shields.io/badge/Construct_2-FF6B6B?style=for-the-badge&logo=game-and-watch&logoColor=white)
...
### 🏥 Site Institucional de Fisioterapia e Pilates
- Desenvolvimento de site institucional responsivo  
- Interface criada com HTML, CSS, JavaScript e React  
- Integração para contato direto via WhatsApp  
- Estruturação modular preparada para futuras integrações  

### 🏋️ Sistema de Controle de Assinaturas para Academias
...
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)]((https://www.instagram.com/n_nana.a/))
